...
- Usa `offsetHeight` cuando necesitas la altura total del elemento, incluyendo los bordes y el scrollbar.
...
Este último es parecido a `offsetHeight` el cual nos muestra la cantidad de scroll total que podemos hacer.
