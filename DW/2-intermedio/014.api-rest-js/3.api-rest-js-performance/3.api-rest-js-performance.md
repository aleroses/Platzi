...
a ✅ este mal
Sí vale la pena. En realidad, el infinite scroll NO ayudaría a aumentar la adicción de los usuarios, pero SÍ ayudaría a subir las ventas porque ayudaría a encontrar más resultados más rápido (y entre más resultados, más compras).

b
No vale la pena. Cambiar la paginación por infinite scroll no aumentaría la adictividad de nuestra tienda.

c ✅ mal📌 
Sí vale la pena. Implementar infinite scroll ayudaría a aumentar la adicción de los usuarios en la tienda (y entre más adicción, más ventas).
...
a ✅ mal
Absolutamente sí: aunque el caché no mejoraría la velocidad en la primera transacción de cada cliente, sí la mejoraría en sus siguientes consultas a la plataforma web.

b
Absolutamente no: el caché NO mejoraría la velocidad, solo sería un paso extra en el flujo de transacciones de los usuarios.

c
Absolutamente sí: el caché mejoraría la velocidad automáticamente para cada visita.
